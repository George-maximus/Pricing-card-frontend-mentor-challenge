function clearAll() {
   const memeContainer = docuent.querySelector('.meme-content');
   const jokeContainer = docuent.querySelector('.joke-content');
   const quoteContainer = docuent.querySelector('.quote-content');
   const riddleContainer = docuent.querySelector('.riddle-content');
...
function showJoke () {
    const randomJokeText = getRandomData('joke');
    const newP =document.createElement('p');
    p.textContent = randomJokes;
    clearAll();
...
function showQuote () {
    const randomQuote = getRandomData('quote');
